...
* PR #507: Fix passing of font options to D2 (@okcodes)
* Issue #509: Resolve compatibility issues with PlantUML 1.2026.2

== 3.2.0

* Issue #501: Add support for https://github.com/charmbracelet/vhs[VHS] (@maxandersen)

Bugfixes::

* Issue #505: Resolve compatibility issues with PlantUML 1.2026.1
